<script>
    ...
    let review = {
      title: "",
      rating: 5, // Initialize rating here
      comment: "",
    };
    ...
    function setRating(selectedRating) {
      review.rating = selectedRating; // Use review.rating instead of a separate rating variable
      errors.rating = null;
    }
    ...
    async function submitReview() {
      ...
      try {
        ...
        let formData = {
          ...
          rating: review.rating, // Use review.rating here
        ...
        setTimeout(() => (submissionSuccess = false), 3000);
      } catch (error) {
        console.log(error);
        ...
        <div class="space-y-6">
          ...
          {#if submissionSuccess}
            <div class="p-4 bg-green-50 rounded-lg border border-green-200 flex items-center gap-3">
              ...
              <span class="text-green-700 font-medium">Thank you! Your review has been {reviewFound ? 'updated' : 'submitted'}.</span>
            </div>
