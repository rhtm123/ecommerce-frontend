							...
							{#if selectedListing.features}
								<div class="mt-6">
									...
									<div class="bg-gray-50 p-4 rounded-md">
										{#if selectedListing.features.general}
											{#each selectedListing.features.general as feature}
												<div class="flex justify-between py-2 border-b border-gray-200 last:border-b-0">
													<span class="text-sm text-gray-600">Feature {feature.feature_template_id}:</span>
